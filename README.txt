...
* get_data.R : An R file to download various macroeconomic data from the World Bank, IMF, UN etc. 
               ...
               have a "label" attribute describind the variable, and (optionally) another "source" attribute providing the source of 
...
Play around with the application to see wverything works find the way you set up up. Once you have created a shinyapps.io account, you can manage and deploy the app from inside Rstudio.
